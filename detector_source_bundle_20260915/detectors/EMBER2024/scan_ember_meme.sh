...
BASE_DIR="/home/rl/RL/dataset/RL_evasion/meme"
SCAN_SCRIPT="./ember_scan.py"
...
scan_dataset() {
    echo
    echo "============================================================"
    echo "BAT DAU QUET THU MUC: $BASE_DIR"
    echo "============================================================"

    for true_label in "${TRUE_LABELS[@]}"; do
        label_dir="$BASE_DIR/$true_label"
        ...
        for file in "${files[@]}"; do
            ...
            echo -ne "Progress [meme/$true_label]: [$current/$total_files] $(basename "$file")\033[0K\r"
...
print_detail_stats() {
    echo
    echo "============================================================"
    echo "BANG THONG KE CHI TIET - meme"
    ...
    for true_label in "${TRUE_LABELS[@]}"; do
        total="${TOTAL[$true_label]:-0}"
        correct="${CORRECT[$true_label]:-0}"
        evaded="${EVADED[$true_label]:-0}"
        benign="${PRED_BENIGN[$true_label]:-0}"
...
print_per_label_breakdown() {
    echo
    echo "============================================================"
    echo "CHI TIET PREDICT THEO TUNG NHAN - meme"
    echo "============================================================"
...
echo "============================================================"
echo "EMBER DETECTION + EVASION STATISTICS - MEME"
