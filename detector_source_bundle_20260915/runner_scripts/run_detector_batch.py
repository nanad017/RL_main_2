...
SOREL_DIR = Path.home() / "detector/sorel_multi"
SOREL_PY = Path.home() / "miniconda3/envs/sorel-malware-detector/bin/python"
SOREL_FFNN = SOREL_DIR / "baselines"
SOREL_LGBM = SOREL_DIR / "baselines/lgbm_seed1.joblib"
SOREL_THRESHOLD = "0.8327"

DEEPMAL_DIR = Path.home() / "detector/deep-mal/deep-malware-detection"
DEEPMAL_PY = DEEPMAL_DIR / "venv_deepmal/bin/python3"
DEEPMAL_CHECKPOINT = DEEPMAL_DIR / "assets/checkpoints/run1.pt"

CNN_DIR = Path.home() / "detector/malware-classification-CNN"
CNN_MODEL = CNN_DIR / "artifacts/combined_local/modellozzo_ckpt.keras"
CNN_CLASS_INDICES = CNN_DIR / "artifacts/combined_local/class_indices.json"

EMBER_DIR = Path.home() / "detector/EMBER2024"
EMBER_MODEL = EMBER_DIR / "models/custom_multiclass.model"
EMBER_LABELS = EMBER_DIR / "dataset_json/family_labels.json"
