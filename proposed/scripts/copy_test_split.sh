...
#
# Vi du:
#   bash scripts/copy_test_split.sh data/splits/samples/test.txt data/samples data/test_samples
#
...
Default paths:
  ...
  source_samples_dir: data/samples
...
SOURCE_DIR="${2:-$PROJECT_ROOT/data/samples}"
