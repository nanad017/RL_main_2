...
from proposed.features import ember
...
ember_model = ember.EmberModel()
malicious_threshold = ember_model.threshold


class EmberEnv(gym.Env):
    ...
    def __init__(
        ...
        random_sample=True,
        maxturns=5,
        output_path="runtime/evaded/ember",
        save_modified_data=False,
        memory_path="runtime/memory/ember",
        reward_fn=None,
    ):
        super().__init__()
        ...
        self.feature_extractor = ember_model.extract
    ...
    def step(self, action_ix):
        ...
        self.score = ember_model.predict_sample(self.observation_space)
        self.queries += 1
    ...
    def reset(self):
        ...
        while True:
            ...
            self.observation_space = self.feature_extractor(self.bytez)
            self.original_score = ember_model.predict_sample(self.observation_space)
