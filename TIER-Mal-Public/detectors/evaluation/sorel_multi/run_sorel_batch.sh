...
SOREL_DIR="${SOREL_DETECTOR_DIR:-$SCRIPT_DIR}"
FFNN_MODEL="${SOREL_FFNN_MODEL:-$SOREL_DIR/baselines}"
LGBM_MODEL="${SOREL_LGBM_MODEL:-$SOREL_DIR/baselines/lgbm_seed1.joblib}"
THRESHOLD="${SOREL_THRESHOLD:-0.8327}"
PYTHON="${SOREL_PYTHON:-python3}"

INPUT_DIRS=(
    "${MAB_DATASET_DIR:-$TIER_ROOT/runtime/datasets/MAB}"
    "${MEME_DATASET_DIR:-$TIER_ROOT/runtime/datasets/meme}"
)

BASE_OUTPUT="${SOREL_OUTPUT_DIR:-$TIER_ROOT/runtime/results}"
