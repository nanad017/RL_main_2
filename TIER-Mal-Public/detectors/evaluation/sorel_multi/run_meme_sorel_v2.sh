#!/usr/bin/env bash
# ============================================================
# run_meme_sorel_v2.sh — Batch MEME detection với resume support
#
# Usage:
#   cd detectors/evaluation/sorel_multi
#   conda activate sorel-malware-detector
#   bash run_meme_sorel_v2.sh
# ============================================================
...
MEME_DIR="${MEME_DATASET_DIR:-$TIER_ROOT/runtime/datasets/meme}"
FFNN_MODEL="$DETECTOR_DIR/baselines"
LGBM_MODEL="$DETECTOR_DIR/baselines/lgbm_seed1.joblib"
THRESHOLD="0.8327"
OUT_DIR="${SOREL_OUTPUT_DIR:-$TIER_ROOT/runtime/results/sorel_meme_batch}"
...
# MAIN
# ═══════════════════════════════════════════════════════════════
JSONL="$OUT_DIR/meme_results.jsonl"
REPORT="$OUT_DIR/meme_report.txt"
...
lines = []
lines.append(SEP1)
lines.append(f"  MEME DETECTION REPORT (sorel) -- {set_name.upper()}")
