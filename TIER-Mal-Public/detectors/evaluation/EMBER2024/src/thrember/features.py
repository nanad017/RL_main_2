...
class AuthenticodeSignature(FeatureType):
    ...
    def raw_features(self, bytez, pe):
        ...
        try:
            ...
            # Some signify versions expose certificate collections that are
            # iterable but not list-like/subscriptable. Keep the sample and
            # mark the signature parse as failed instead of dropping it.
            raw_obj["parse_error"] = 1
